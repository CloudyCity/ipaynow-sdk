...
namespace CloudyCity\IPayNowSDK;

use CloudyCity\IPayNowSDK\Exceptions\BusinessException;
use CloudyCity\IPayNowSDK\Exceptions\GatewayException;
use CloudyCity\IPayNowSDK\Exceptions\InvalidConfigException;
...
class IPayNow
{
     ...
     * @param $returnUrl
     */
    protected function __construct($appid, $key, $channel, $notifyUrl, $returnUrl)
    {
        $this->appid = $appid;
        $this->key = $key;
